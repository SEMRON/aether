...
def _get_expert_stub(endpoint: Endpoint, *extra_options: Tuple[str, Any]):
    ...
    return ChannelCache.get_stub(endpoint, swarm_runtime_grpc.SwarmConnectionHandlerStub, aio=False, options=channel_options)
...
class RemoteExpert(nn.Module):
    ...
    def __init__(self, uid, endpoint: Endpoint):
        """
        Initialize a RemoteExpert instance.
        
        :param uid: Unique expert identifier
        :param endpoint: Network endpoint of the expert server
        """
        super().__init__()
    ...
    def info(self):
        """
        Get expert metadata including input/output schemas and other configuration.
        
        :returns: Dictionary containing expert metadata retrieved from the server
        """
    ...
    def extra_repr(self):
        """
        Return a string representation of the RemoteExpert for debugging.
        
        :returns: String containing UID and endpoint information
        """
...
class _RemoteModuleCall(torch.autograd.Function):
    ...
    def forward(
        ...
        dummy: torch.Tensor,
        uid: str,
        stub: swarm_runtime_grpc.SwarmConnectionHandlerStub,
        info: Dict[str, Any],
        *inputs: torch.Tensor,
    ) -> Tuple[torch.Tensor, ...]:
